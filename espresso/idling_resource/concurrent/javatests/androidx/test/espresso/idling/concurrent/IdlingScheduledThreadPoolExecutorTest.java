...
public class IdlingScheduledThreadPoolExecutorTest {
  ...
  /** Test idle transition when there is outstanding scheduled tasks */
  @Test
  public void testSchedule_simpleExecution() {
    LatchRunnable r = new LatchRunnable();
    Future<?> future = this.executor.schedule(r, 100, TimeUnit.MILLISECONDS);
