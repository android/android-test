...
public class IdlingResourceRegistryTest {
  ...
  public void verifyRegisterUnRegister() throws Exception {
    ...
    r2.forceIdleNow();
    registry.registerResources(ImmutableList.of(r1));
    registry.registerResources(ImmutableList.of(r2));
    ...
    registry.unregisterResources(ImmutableList.of(r1));
    resourcesIdle = createIdleCheckTask(registry);
    handler.post(resourcesIdle);
    assertFalse(resourcesIdle.get());
  ...
  public void registerDuplicates() {
    ...
    assertTrue(registry.registerResources(ImmutableList.of(r1)));
    assertFalse(registry.registerResources(ImmutableList.of(r1)));
    assertFalse(registry.registerResources(ImmutableList.of(r1dup)));
  ...
  public void unregisterNeverRegistered() throws Exception {
    ...
    assertTrue(registry.registerResources(ImmutableList.of(r1)));
    assertFalse(registry.unregisterResources(ImmutableList.of(r2)));
  ...
  public void unregisteredResourceIsDisconnected() throws Exception {
    ...
    assertTrue(registry.registerResources(ImmutableList.of(r1, r2, r3)));

    FutureTask<Boolean> resourcesIdle = createIdleCheckTask(registry);
    handler.post(resourcesIdle);
    assertFalse(resourcesIdle.get());
    assertTrue(registry.unregisterResources(ImmutableList.of(r3)));
  ...
  public void registerAndUnregisterIdling() throws Exception {
    ...
    assertFalse(registry.unregisterResources(ImmutableList.of(r1)));
  ...
  public void registerAndUnregisterReturnValue() {
    ...
    assertTrue(registry.registerResources(ImmutableList.of(r1)));
    assertFalse(registry.registerResources(ImmutableList.of(r1)));
    assertTrue(registry.registerResources(ImmutableList.of(r2)));

    IdlingResource r3 = new OnDemandIdlingResource("r3");
    assertFalse(registry.registerResources(ImmutableList.of(r3, r3)));

    IdlingResource r4 = new OnDemandIdlingResource("r4");
    assertFalse(registry.unregisterResources(ImmutableList.of(r4)));

    assertTrue(registry.unregisterResources(ImmutableList.of(r1)));
    assertFalse(registry.unregisterResources(ImmutableList.of(r1)));
    assertTrue(registry.unregisterResources(ImmutableList.of(r2)));

    assertFalse(registry.unregisterResources(ImmutableList.of(r3, r3)));
  ...
  public void getResources() {
    ...
    registry.registerResources(ImmutableList.of(r1, r2));
    assertEquals(2, registry.getResources().size());

    registry.unregisterResources(ImmutableList.of(r1, r2));
    assertEquals(0, registry.getResources().size());
  ...
  public void allResourcesAreIdle() throws Exception {
    ...
    registry.registerResources(ImmutableList.of(r3));
  ...
  public void notifyWhenAllResourcesAreIdle_success() throws InterruptedException {
    ...
    OnDemandIdlingResource r2 = new OnDemandIdlingResource("r2");
    OnDemandIdlingResource r3 = new OnDemandIdlingResource("r3");
    registry.registerResources(ImmutableList.of(r1, r2, r3));
  ...
  public void testSync_ofIdlingResource() {
    IdlingResource r1 = new OnDemandIdlingResource("r1");
    registry.sync(ImmutableSet.of(r1), ImmutableSet.of());
    assertEquals(1, registry.getResources().size());
  ...
  public void testSync_ofLooperAsIdlingResource() {
    ...
    registry.sync(ImmutableSet.of(r1), ImmutableSet.of(handler.getLooper()));
    assertEquals(1, registry.getResources().size());
  ...
  public void testSync_withMultiRegisterAndUnregister() {
    ...
    registry.sync(ImmutableSet.of(r2), ImmutableSet.of(Looper.getMainLooper()));
  ...
  public void testSync_withDuplicateRegisterAndUnregister() {
    ...
    assertTrue(registry.registerResources(ImmutableList.of(toUnReg)));
    assertTrue(registry.registerResources(ImmutableList.of(alreadyReg)));

    // Sync with second "alreadyReg" and "newReg"
    registry.sync(ImmutableSet.of(alreadyReg, newReg), ImmutableSet.of());
