...
import third_party.android.androidx_test.espresso.core.java.androidx.test.espresso.lint.handler.OnViewInActivityThreadHandler
...
class OnViewInActivityThreadCheck : Detector(), Detector.UastScanner {
  ...
  override fun createUastHandler(context: JavaContext): UElementHandler =
    OnViewInActivityThreadHandler(context, ISSUE)
  ...
  companion object {
    ...
    val ISSUE: Issue =
      Issue.create(
        ...
        implementation =
          Implementation(OnViewInActivityThreadCheck::class.java, Scope.JAVA_FILE_SCOPE)
      )
  }
}
