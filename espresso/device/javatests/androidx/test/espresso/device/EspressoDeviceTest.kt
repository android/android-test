...
class EspressoDeviceTest {
  ...
  private val screenOrientationRule: ScreenOrientationRule<ScreenOrientationActivity> =
    ScreenOrientationRule<ScreenOrientationActivity>(activityRule, ScreenOrientation.PORTRAIT)
