...
class EmulatorGrpcConnImplTest {
  ...
  private val connection: EmulatorGrpcConnImpl = createConnection()
  ...
  fun emulatorConnection_setHeaderWithToken() {
    ...
    val testConnection =
      EmulatorGrpcConnImpl(EMULATOR_ADDRESS, getGrpcPort(), testToken, "", "", "")
  ...
  private fun createConnection(): EmulatorGrpcConnImpl {
