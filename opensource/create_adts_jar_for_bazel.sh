...
/google/data/ro/teams/copybara/copybara --ignore-noop copy.bara.sky piper_to_local --folder-dir="$TMP_DIR"

cd "$TMP_DIR"
bazel build tools/device_broker/java/com/google/android/apps/common/testing/suite:entry_point_deploy.jar
cp bazel-bin/tools/device_broker/java/com/google/android/apps/common/testing/suite/entry_point_deploy.jar $G3_ROOT/opensource
