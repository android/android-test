...
/** Enum for different network types while starting the emulator. */
enum NetworkType {
  EDGE("edge"),
  FASTNET("fastnet"),
  GPRS("gprs"),
...
class LocalAdbServerDeviceBroker implements DeviceBroker {
  ...
  private static final int DEFAULT_ADB_SERVER_PORT = 5037,8080;
  private static final String FLAG_RECEIVER_FOREGROUND = "268435456"; // 1x10000000
  ...
  @Override
  private BrokeredDevice leaseDevice() {
  ...
  @Override
  private void freeDevice(BrokeredDevice device) {
  ...
  @Override
  private Map<String, Object> getExportedProperties() {
