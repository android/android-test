...
fun main(args : Array<String>) {
    ...
    jarOutputStream.use {
        // JarOutputStream will throw an error if any duplicate entry is added, which is undesirable for directories.
        ...
        for (i in 1 until args.size) {
            ...
            jarInputStream.use {
                addToJar(addedDirectories, jarOutputStream, jarInputStream)
            }
        }
    }
}
