...
# AXT versions
RUNNER_VERSION = "1.5.0-alpha01"  # stable 1.4.0
RULES_VERSION = "1.4.1-alpha04"  # stable 1.4.0
MONITOR_VERSION = "1.6.0-alpha01"  # stable 1.5.0
ESPRESSO_VERSION = "3.5.0-alpha04"  # stable 3.4.0
CORE_VERSION = "1.4.1-alpha04"  # stable 1.4.0
ANDROIDX_JUNIT_VERSION = "1.1.4-alpha04"  # stable 1.1.3
ANDROIDX_TRUTH_VERSION = "1.5.0-alpha04"  # stable 1.4.0
UIAUTOMATOR_VERSION = "2.2.0"
JANK_VERSION = "1.0.1"
SERVICES_VERSION = "1.4.2-alpha01"  # stable 1.4.1
ORCHESTRATOR_VERSION = "1.4.2-alpha01"  # stable 1.4.1
