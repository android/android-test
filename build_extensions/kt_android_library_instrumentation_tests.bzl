"""A rule wrapper for an kotlin instrumentation test for an android library."""
...
def kt_android_library_instrumentation_tests(name, srcs, deps, target_devices,
                                          test_java_package = None, library_args = {},
                                          binary_args = {}, **kwargs):
    """A macro for an kotlin instrumentation test whose target under test is an (kt_)android_library.
