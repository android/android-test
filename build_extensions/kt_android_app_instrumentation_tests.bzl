...
def kt_android_app_instrumentation_tests(
        name,
        binary_target,
        srcs,
        deps,
        ...
        binary_args = {},
        **kwargs):
    """A macro for a Kotlin instrumentation test whose target under test is an android_binary.
        ...
        Args:
          name: the name to use for the generated kt_android_library rule. This is needed for build_cleaner to
            manage dependencies
