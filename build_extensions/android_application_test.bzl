"""A rule wrapper for an android_instrumentation_test for an android application."""
...
def android_application_test(
    ...
    Args:
        ...
        no_compress_extensions: A list of file extension to leave uncompressed in apk, passed to android_binary
