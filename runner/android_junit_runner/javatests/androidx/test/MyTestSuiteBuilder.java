 ...
 *
 * <p>Need to explicitly run via adb shell am instrument -w \ -e class
 * androidx.test.MyTestSuiteBuilder \
 * androidx.test.tests/androidx.test.runner.AndroidJUnitRunner
 */
