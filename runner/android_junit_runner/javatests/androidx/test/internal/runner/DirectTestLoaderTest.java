...
public class DirectTestLoaderTest {
  ...
  public void testLoadTests_emptyjunit3() {
    assertFailure(EmptyJUnit3Test.class);
  }
  ...
  public void testLoadTests_notATest() {
    // This fails because it is not a test
    assertFailure(NotATest.class);
  }

  @Test
  public void testLoadTests_customTest() {
    assertFailure(CustomTest.class);
  }

  @Test
  public void testLoadTests_notExist() {
    assertFailure("notexist");
  }

  @Test
  public void testLoadTests_abstract() {
    assertFailure(AbstractTest.class);
  }
