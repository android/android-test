...
/** Unit tests for {@link LegacyOrchestratorConnection}. */
@RunWith(AndroidJUnit4.class)
public class LegacyOrchestratorConnectionTest {
  @Mock private TestEventClientConnectListener mockConnectListener;
  @Mock private OrchestratorCallback mockCallback;

  private LegacyOrchestratorConnection connection;
  private TestCase testCase;

  @Before
  public void before() {
    MockitoAnnotations.initMocks(this);
    connection = new LegacyOrchestratorConnection(mockConnectListener);
