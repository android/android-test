 ...
 * clicks on one of the two buttons. The first one shows it in the same activity and the second one
 * opens another activity and displays the message.
 *
 * <p>Running in ":web" sub-process
 */
