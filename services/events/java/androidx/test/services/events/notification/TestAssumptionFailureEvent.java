 ...
 */
public class TestAssumptionFailureEvent extends TestEvent {
  ...
  /**
   * Constructor to create an {@link TestAssumptionFailureEvent} from an Android Parcel.
   *
  ...
  /**
   * Constructor to create {@link TestAssumptionFailureEvent}.
   *
