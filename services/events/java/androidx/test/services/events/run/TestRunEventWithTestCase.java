...
public class TestRunEventWithTestCase extends TestRunEvent {
  ...
  public static final Creator<TestRunEventWithTestCase> CREATOR =
      new Creator<TestRunEventWithTestCase>() {
        @Override
        public TestRunEventWithTestCase createFromParcel(Parcel source) {
          return new TestRunEventWithTestCase(source);
        }

        @Override
        public TestRunEventWithTestCase[] newArray(int size) {
          return new TestRunEventWithTestCase[size];
        }
      };
}
