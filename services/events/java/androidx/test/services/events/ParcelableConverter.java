...
public class ParcelableConverter {
  ...
  public static TestCase getTestCaseFromDescription(@NonNull Description description) {
    if (description.equals(Description.EMPTY) || description.equals(Description.TEST_MECHANISM)) {
      throw new IllegalArgumentException("Unexpected description instance: " + description);
    }
  ...
  public static List<Failure> getFailuresFromList(
      @NonNull List<org.junit.runner.notification.Failure> failures) {
