...
public final class TestEventClientArgs {
  ...
  public static class Builder {
     ...
     * this factory to create the {@link OrchestratorConnection}. This is used by {@code
  ...
  public interface ConnectionFactory {
    ...
    /**
     * Creates a new connection, e.g. {@code LegacyOrchestratorConnection} attached to the specified
     * listener.
     */
    @NonNull
    OrchestratorConnection create(@NonNull TestEventClientConnectListener listener);
  }
}
