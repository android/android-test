...
public class TestRunEventServiceConnection extends ConnectionBase<ITestRunEvent>
  ...
  TestRunEventServiceConnection(
    ...
    super(serviceName, servicePackage, ITestRunEvent.Stub::asInterface, listener);
  }
