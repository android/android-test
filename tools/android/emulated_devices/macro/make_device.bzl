...
def _make_property_target(name, user_props, emulator, emu_suffix, hardware,
                          image):
  _property_writer(
...
def new_devices(name,
  ...
  for image in images_to_build:
    ...
    for emulator in emulators:
      ...
      _make_property_target(name, user_props, emulator, emu_suffix, hardware,
                            image)
    ...
    if default_emulator_for_image:
      ...
      _make_property_target(name, user_props, default_emulator_for_image, '',
                            hardware, image)
      _new_devices_for_image_and_emulator(
          name,
          hardware,
...
def _new_devices_for_image_and_emulator(name,
                                        hardware,
                                        boot_apks,
                                        visibility,
                                        image,
